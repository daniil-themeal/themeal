...
import { LinkIcon } from '../../components/common/icons/feather/LinkIcon';
import { Share2Icon } from '../../components/common/icons/feather/Share2Icon';
...
function useBlogPostShareUrl(slug: string): string {
  const path = BLOG_ROUTES.post(slug);
...
export function BlogShareButtons({ title, slug, labels }: BlogShareButtonsProps) {
  const url = useBlogPostShareUrl(slug);
