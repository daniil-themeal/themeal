...
type BottomFloatTotalBlockCssVariables = CSSProperties & {
  "--bottom-total-bg": string;
  "--bottom-total-tab-bg": string;
  "--bottom-total-text": string;
  "--bottom-total-muted": string;
  "--bottom-total-subtle": string;
  "--bottom-total-primary": string;
  "--bottom-total-primary-muted": string;
  "--bottom-total-active-bg": string;
  "--bottom-total-border": string;
  "--bottom-total-menu-toggle-font-size": string;
  "--bottom-total-date-font-size": string;
  "--bottom-total-small-font-size": string;
  "--bottom-total-meal-title-font-size": string;
  "--bottom-total-price-font-size": string;
};

const bottomFloatTotalBlockStyle: BottomFloatTotalBlockCssVariables = {
  "--bottom-total-bg": COLOR_TOKENS.base.white,
  "--bottom-total-tab-bg": COLOR_TOKENS.neutral[75],
  "--bottom-total-text": COLOR_TOKENS.neutral[900],
  "--bottom-total-muted": COLOR_TOKENS.neutral[500],
  "--bottom-total-subtle": COLOR_TOKENS.neutral[100],
  "--bottom-total-primary": COLOR_TOKENS.primary[500],
  "--bottom-total-primary-muted": COLOR_TOKENS.primary[400],
  "--bottom-total-active-bg": COLOR_TOKENS.primary[50],
  "--bottom-total-border": COLOR_TOKENS.neutral[100],
  "--bottom-total-menu-toggle-font-size": FONT_SIZE_TOKENS[12],
  "--bottom-total-date-font-size": FONT_SIZE_TOKENS[16],
  "--bottom-total-small-font-size": FONT_SIZE_TOKENS[12],
  "--bottom-total-meal-title-font-size": FONT_SIZE_TOKENS[16],
  "--bottom-total-price-font-size": FONT_SIZE_TOKENS[20],
};
...
export function BottomFloatTotalBlock({
  ...
  const handleMealsTouchMove = (event: React.TouchEvent<HTMLDivElement>) => {
    const scrollContainer = mealsScrollRef.current;
    if (!scrollContainer) return;
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full overflow-hidden bg-[var(--bottom-total-bg)] drop-shadow-[0px_-4px_12px_rgba(0,0,0,0.08)]">
          <div className="relative">
            {menuVisible ? (
              <div
                className={`${menuClosing ? "modal-exit-mobile-full" : "modal-enter-mobile-full"} relative z-0 bg-[var(--bottom-total-bg)]`}
              ...
              >
                <div className="px-[20px] pt-[20px]">
                  <div className="flex w-full items-stretch">
                    <button
                      ...
                      className={`flex w-[40px] shrink-0 items-center justify-center rounded-[8px] transition-colors hover:bg-[var(--bottom-total-active-bg)] ${
                        !canGoPrev
                    ...
                    >
                      <div className="relative flex w-[200%]">
                        {menuDays.map((d) => {
                          const active =
                            d.absoluteDayIndex === selectedDayIndex;
                          ...
                          return (
                            <button
                              ...
                              className={`relative flex flex-[0_0_calc(100%/14)] cursor-pointer flex-col items-center justify-center gap-[6px] rounded-[8px] py-[8px] hover:bg-[var(--bottom-total-active-bg)] ${
                                active
                                  ? "bg-[var(--bottom-total-active-bg)]"
                                  : ""
                              }`}
                            >
                ...
                <div className="relative">
                  <div
                    ...
                    className="flex cursor-grab touch-pan-x select-none gap-[12px] overflow-x-auto px-[20px] py-[16px] scrollbar-hide active:cursor-grabbing"
                  >
                  ...
                  <div
                    className="pointer-events-none absolute bottom-0 left-0 top-0 w-[20px]"
                    style={{
                      background: `linear-gradient(to left, transparent, ${COLOR_TOKENS.base.white})`,
                    }}
                  />
                  <div
                    className="pointer-events-none absolute bottom-0 right-0 top-0 w-[20px]"
                    style={{
            ...
            <div className="relative z-10 w-full bg-[var(--bottom-total-bg)]">
              ...
              <div className="h-px w-full bg-[var(--bottom-total-border)]" />
            </div>
          </div>
        </div>
      </div>
