    ...
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <div className="relative shrink-0 w-full">
        <div className="content-stretch flex gap-[3px] items-baseline px-[2px] relative size-full">
          <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Quicksand:SemiBold',sans-serif] leading-[1.2] min-w-px not-italic relative text-[#8594ac] text-[14px] tracking-[0.14px] uppercase">
            {label}
          </p>
        </div>
      </div>
          ...
          <div className="content-stretch flex flex-[1_0_0] items-center min-w-px overflow-clip relative">
            ...
            <div className="content-stretch flex flex-[1_0_0] h-[56px] items-center min-w-px relative">
              <input
                ...
                className="bg-transparent border-none outline-none flex-[1_0_0] font-['Quicksand:SemiBold',sans-serif] leading-[1.3] min-w-px text-[#383e48] text-[20px] h-full px-2"
              />
            </div>
      ...
      {hasError && (
        <div className="relative shrink-0 w-full">
          <div className="content-stretch flex items-start p-[2px] relative size-full">
            <p className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex-[1_0_0] font-['Quicksand:SemiBold',sans-serif] leading-[1.5] min-w-px not-italic relative text-[#f04e4c] text-[12px]">
              {error}
            </p>
          </div>
        </div>
