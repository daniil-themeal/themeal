...
export const ICON_TEXT_ROW_LAYOUT = {
  ...
  row: 'flex h-fit w-full items-center justify-center gap-[12px] [&>*:first-child]:block [&>*:first-child]:shrink-0 [&>*:first-child]:leading-none [&>*:first-child]:text-[var(--icon-text-row-icon)]',
