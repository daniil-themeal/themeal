...
function MealImg({ src, delay, active }: { src: string; delay: number; active: boolean }) {
  return (
    <div
      className="shrink-0 w-[120px] sm:w-[200px] lg:w-[230px] xl:w-[264px] aspect-[218/160] rounded-[8px] xl:rounded-[12px] overflow-hidden"
      style={active
...
export default function HeroMealsSection() {
  ...
  return (
    <div className="relative w-full overflow-hidden flex flex-col justify-end gap-[16px] xl:gap-[24px]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[rgba(65,24,100,0.45)] to-[rgba(65,24,100,0.85)] pointer-events-none" />
    </div>
  );
}
