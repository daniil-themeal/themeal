              ...
              return (
                ...
                >
                  <div className="flex w-full flex-col items-center gap-[4px]">
                    <p
                      className={`font-sans text-[length:var(--menu-day-selector-date-font-size)] font-bold leading-none tracking-[length:var(--letter-spacing-label16)] transition-colors duration-200 ${
                        active
                    ...
                    <p
                      className={`font-sans text-[length:var(--menu-day-selector-meta-font-size)] font-bold leading-none tracking-[length:var(--letter-spacing-label12)] transition-colors duration-200 ${
                        active
                          ? 'text-[var(--menu-day-selector-active)]'
                          : 'text-[var(--menu-day-selector-text)]'
                      }`}
                  ...
                  <p
                    className={`font-sans text-[length:var(--menu-day-selector-meta-font-size)] font-medium leading-none tracking-[length:var(--letter-spacing-label12)] transition-colors duration-200 ${
                      active
