...
import { CHECKOUT_STEP_HEADER_PADDING_TOP_CLAMP } from './checkoutSpacing';
...
export const CHECKOUT_STEP_PAGE_LAYOUT = {
  ...
  header: 'mx-auto flex h-fit w-full max-w-[688px] flex-col gap-[12px] bg-[var(--checkout-step-surface)] px-[20px] pt-[length:var(--checkout-step-header-pt)] text-center md:bg-transparent md:px-0 md:pt-0',
  headerTitle: [
