// BACKUP — прежняя версия иконки WhatsApp с белой обводкой (кольцом).
// Для отката: скопируйте функцию OrderFabWhatsAppIcon ниже обратно в OrderFab.tsx
// (восстанавливается второй <path fill="#fff"> — белая обводка вокруг зелёного пузыря).
