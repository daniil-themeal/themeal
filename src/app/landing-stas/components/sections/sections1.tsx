    ...
    createElement('section', { className:'section section--cream', id:'why' },
      createElement('div', { className:'wrap' },
        ...
        createElement('div', { className:'grid-12 compare-cards', style:{ alignItems:'stretch' } },
          /* problems */
          createElement('div', { className:'card reveal', style:{ padding:'32px 24px', background:'var(--cream-2)', boxShadow:'none' } },
            createElement('div', { className:'compare-card-head compare-card-head--problems' }, t.compare.problemsTitle),
            createElement('ul', { className:'stack', style:{ listStyle:'none', margin:0, padding:0, gap:'var(--space-16)' } },
              t.compare.problems.map((p,i)=>createElement('li', { key:i, className:'row', style:{ gap:'var(--space-16)', width:'100%', alignItems:'center', color:'var(--slate)', fontWeight:600, fontSize:'var(--fs-16)' } },
          ...
          createElement('div', { className:'card reveal', 'data-d':'1', style:{ paddingTop:'var(--space-20)', paddingBottom:'var(--space-32)', paddingLeft:'40px', paddingRight:'40px', background:'var(--plum-700)', color:'#fff', boxShadow:'var(--shadow-lg)', position:'relative', overflow:'visible' } },
            createElement('div', { className:'compare-card-head compare-card-head--solutions' },
              ...
              createElement(Logo, { tone: 'yellow' })),
            createElement('ul', { className:'stack', style:{ listStyle:'none', margin:0, padding:0, gap:'var(--space-16)' } },
              t.compare.solutions.map((s,i)=>createElement('li', { key:i, className:'row', style:{ gap:'var(--space-16)', width:'100%', alignItems:'center', fontWeight:600, fontSize:'var(--fs-16)' } },
        ...
        t.compare.compare && createElement('div', { className:'card reveal', style:{ background:'#fff', padding:'clamp(var(--space-24), 3vw, var(--space-32))', paddingTop:'var(--space-16)', marginTop:'var(--space-24)', height:'fit-content' } },
          ...
          createElement('div', { className:'compare-cost-grid' },
            t.compare.compare.map((c,i)=>createElement('div', { key:i, className:'stack' },
              createElement('span', { style:{ fontSize:'var(--fs-16)', fontWeight:600, color: c.hot?'var(--brand)':'#8A8694', display:'flex', alignItems:'center', gap:'var(--space-8)' } },
