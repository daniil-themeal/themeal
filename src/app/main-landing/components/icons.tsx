...
const Logo = ({ height = 26, tone = 'yellow', color, accent, style }: LogoProps = {}) => {
  ...
  const textColor = color ?? 'var(--yellow)';
  const leafColor = accent ?? textColor;
...
const SOCIAL_CIRCLE_PATH =
  'M11.94 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0a12 12 0 00-.06 0';

const FACEBOOK_F_PATH =
  'M14 13.5h2.5l1.4-4.5H14v-2.2c0-.9.2-1.5 1.5-1.5H17.5V2.1C17.2 2 15.7 2 14 2c-3.3 0-5.5 2-5.5 5.6V9H6v4.5h2.5V22h5.5V13.5z';

const Social = {
  facebook: (p: LandingIconProps = {}) => {
    ...
    return createElement(
      ...
      createElement('path', { d: SOCIAL_CIRCLE_PATH }),
      createElement('path', { d: FACEBOOK_F_PATH }),
    );
  },
